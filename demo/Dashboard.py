...
try:
    ...
    # when running from inside demo/
    from history_utils import load_recent_alerts  # type: ignore
...
def main() -> None:
    """Entry point for `streamlit run demo/dashboard.py`."""
    ...
    # Single render per Streamlit run
    render_loop()
...
if __name__ == "__main__":
    ...
    # or   python -m demo.dashboard   (not under pytest import)
    main()
